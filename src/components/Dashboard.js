...
import { PlusSquareIcon, RepeatIcon, SettingsIcon } from "@chakra-ui/icons"
...
const userFunctionIds = async (articles, user) => {
  if (articles) {
...
const Dashboard = ({ user }) => {
  ...
  useEffect(() => {
    // anonymous function
    ;(async () => {
      const listOfId = await userFunctionIds(articles, user)
                    ...
                    <AccordionItem>
                      ...
                      <AccordionPanel pb={4}>
                        <Box key={article.id}>
                          ...
                          <Text>
                            Nb of comments: {article.comments.length}{" "}
                          </Text>
                        </Box>
                      </AccordionPanel>
                    </AccordionItem>
